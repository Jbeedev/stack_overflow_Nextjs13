...
const Theme = () => {
  ...
  return (
    <Menubar className="relative border-none bg-transparent shadow-none">
      <MenubarMenu>
        <MenubarTrigger className="focus:bg-light-900 
        ...
        <MenubarContent className="absolute right-[-3rem] mt-3 min-w-[120px] 
        rounded border py-2 dark:border-dark-300 dark:bg-dark-200">
          {themes.map((item) => (
            <MenubarItem className="flex items-center gap-5 px-2.5 py-2 focus:bg-dark-400 "
